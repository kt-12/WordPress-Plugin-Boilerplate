...
class PluginNameLoader
{
     ...
     * @param    string      $callback             The name of the function definition on the $component.
     * @param    int   $priority      Optional. he priority at which the function should be fired. Default is 10.
     * @param    int   $acceptedArgs   Optional. Arguments count that should be passed to the $callback. Default is 1
     */
    ...
    public function run()
    {
        foreach ($this->filters as $hook) {
            ...
            add_filter($hookName, array( $component, $callback ), $priority, $acceptedArgs);
        }
        ...
        foreach ($this->actions as $hook) {
            ...
            $priority = $hook['priority'];
            $acceptedArgs = $hook['acceptedArgs'];
            add_action($hookName, array( $component, $callback ), $priority, $acceptedArgs);
        }
    }
}
